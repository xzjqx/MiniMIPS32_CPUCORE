...
/************************UPDATE--添加两个CP0寄存器*******************************/
`define CP0_COUNT           9               // Count寄存器地址（编号）
`define CP0_COMPARE         11              // Compare寄存器地址（编号）
/************************UPDATE--添加两个CP0寄存器*******************************/
...
/************************UPDATE--更改异常和中断的入口地址*******************************/
`define EXC_ADDR            32'h80000380    // 异常处理程序入口地址
`define EXC_INT_ADDR        32'h80000380    // 中断异常处理程序入口地址
/************************UPDATE--更改异常和中断的入口地址*******************************/
